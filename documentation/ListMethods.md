...
print(list[0:3]) --- slices the list and returns values 1, 2, 3 corresponding to 0, 1 and 2, missing out the first or second nymber tells python either do it from start or to end of list, negative values can be used
